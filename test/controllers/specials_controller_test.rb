...
class SpecialsControllerTest < ActionController::TestCase
  ...
  test "should create special" do
    assert_difference('Special.count') do
      post :create, special: { bar_id: @special.bar_id, description: @special.description, times: @special.times }
    end
  ...
  test "should update special" do
    patch :update, id: @special, special: { bar_id: @special.bar_id, description: @special.description, times: @special.times }
    assert_redirected_to special_path(assigns(:special))
  end
