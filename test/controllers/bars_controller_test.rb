...
class BarsControllerTest < ActionController::TestCase
  ...
  test "should create bar" do
    assert_difference('Bar.count') do
      post :create, bar: { address: @bar.address, name: @bar.name, phone_number: @bar.phone_number }
    end
  ...
  test "should update bar" do
    patch :update, id: @bar, bar: { address: @bar.address, name: @bar.name, phone_number: @bar.phone_number }
    assert_redirected_to bar_path(assigns(:bar))
  end
